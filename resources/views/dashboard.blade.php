    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                ...
                <p style="text-decoration-line: underline" class="mg-b-0"><a href="https://.{{ auth()->user()->email }}">
                        {{ auth()->user()->email }}</a></p>
            </div>
        </div>
                        ...
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-5 text-white op-7">
                                    <a style="margin-top:10px;display: inline-block;color: white;text-decoration-line:underline"
                                        href="{{ route('all_Invoices') }}">اضغط هنا لعرض كل الفواتير</a>
                                </p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-5 text-white op-7"><a
                                        style="margin-top: 10px;display: inline-block; color: white;text-decoration-line:underline"
                                        href="{{ route('invoices_unpaid') }}">اضغط هنا لعرض كل الفواتير الغير مدفوعه</a>
                                </p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-5 text-white op-7"><a
                                        style="margin-top: 10px;display: inline-block;color: white;text-decoration-line:underline"
                                        href="{{ route('invoices_paid') }}">اضغط هنا لعرض كل الفواتير المدفوعه</a></p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-5 text-white op-7"><a
                                        style="margin-top:10px;display: inline-block;color: white;text-decoration-line:underline"
                                        href="{{ route('invoices_partial_paid') }}">اضغط هنا لعرض كل الفواتير المدفوعه
                                        جزئيا</a>
                                </p>
                            </div>
